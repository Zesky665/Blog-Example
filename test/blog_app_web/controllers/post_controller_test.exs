defmodule BlogAppWeb.PostControllerTest do
  ...
  @create_attrs %{body: "some body", public: true, summary: "some summary", title: "some title"}
  @update_attrs %{body: "some updated body", public: false, summary: "some updated summary", title: "some updated title"}
  @invalid_attrs %{body: nil, public: nil, summary: nil, title: nil}
